...
$dbname = "jenel";         // Change this to your database name
...
$hotelDetails = ['hotelName' => '', 'hotelCost' => 0]; // Initialize with default values
...
if ($hotelResult->num_rows > 0) {
    ...
    $hotelDetails['hotelName'] = $row['hotel'] ?? ''; // Set hotel name, or empty string if not found
    $hotelDetails['hotelCost'] = $row['cost'] ?? 0;   // Set hotel cost, or 0 if not found
}
...
if ($cityResult->num_rows > 0) {
    ...
    $cityName = $row['city'] ?? ''; // Set city name, or empty string if not found
}
...
<body>
    <div class="card-container">
        ...
        <form method="post" action="payment.php">
            ...
            <p>Cost: ₱ <span id="calculatedCost"><?php echo $initialCost; ?></span></p>
    ...
    <script>
        ...
        function calculateCost() {
            ...
            const days = 5; // Replace with actual journey days from the database
