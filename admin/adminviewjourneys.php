        ...
        <div class="filter-box">
            ...
            <div class="custom-dropdown">
                ...
                <div id="seasonDropdown" class=" custom-dropdown-content">
                    ...
                    <label><input type="checkbox" name="season[]" value="Dry" <?php if (in_array("Dry", $selectedSeasons)) echo "checked"; ?>>Dry</label>
                    <label><input type="checkbox" name="season[]" value="Wet" <?php if (in_array("Wet", $selectedSeasons)) echo "checked"; ?>>Wet</label>
                </div>
            </div>
